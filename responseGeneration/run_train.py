...
from reponseGeneration import model
...
def train():
    ...
    parser.add_argument("--train_path", type=str, default="../data/DuRecDial/new_sample_train.json",
                        help="Path of the train dataset")
    parser.add_argument("--valid_path", type=str, default="../data/DuRecDial/new_sample_dev.json",
    ...
    parser.add_argument('--log_dir', type=str, default="../logs/ResponseGeneration",
                        help="Output logs to a dir")

    parser.add_argument("--model_checkpoint", type=str, default="../config/gpt2-chinese-cluecorpussmall", help="Path or URL of the model")
    ...
    parser.add_argument("--valid_batch_size", type=int, default=6, help="Batch size for validation")
    ...
    parser.add_argument("--warmup_steps", type=int, default=3000, help="Warm up steps")
    ...
    #model = GPT2LMHeadModel.from_pretrained("uer/gpt2-chinese-cluecorpussmall")#初始化模型
    ...
    train_data = load_data(tokenizer, logger, args.train_path, args.cache_dir, 
        data_partition="train", use_goal=args.use_goal)
    valid_data = load_data(tokenizer, logger, args.valid_path, args.cache_dir, 
        data_partition="valid", use_goal=args.use_goal)
    ...
    if args.local_rank in [-1, 0]:
        ...
        # set log dir
        log_dir = args.log_dir + '_w_Goal' if args.use_goal else args.log_dir
        ...
        getattr(model, 'module', model.gpt2).config.to_json_file(os.path.join(tb_logger.writer.logdir, CONFIG_NAME))
